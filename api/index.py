/* -----------------------------------------------------------
   ...
   - Question image caching support
   - Individual CFRN domain file support
----------------------------------------------------------- */
...
// CFRN domain routes
const CFRN_DOMAIN_ROUTES = [
  '/category/Nursing_Certifications/CFRN/domain/General%20Principles%20of%20Flight%20Transport%20Nursing%20Practice',
  '/category/Nursing_Certifications/CFRN/domain/Resuscitation%20Principles',
  '/category/Nursing_Certifications/CFRN/domain/Trauma',
  '/category/Nursing_Certifications/CFRN/domain/Medical%20Emergencies',
  '/category/Nursing_Certifications/CFRN/domain/Special%20Populations',
];
...
const JSON_PRECACHE = [
  ...
  '/modules/Nursing_Certifications/CCRN_Comprehensive.json',

  // Nursing Certifications — CFRN individual domain files (primary)
  '/modules/Nursing_Certifications/CFRN_General_Principles_of_Flight_Transport_Nursing_Practice.json',
  '/modules/Nursing_Certifications/CFRN_Resuscitation_Principles.json',
  '/modules/Nursing_Certifications/CFRN_Trauma.json',
  '/modules/Nursing_Certifications/CFRN_Medical_Emergencies.json',
  '/modules/Nursing_Certifications/CFRN_Special_Populations.json',

  // Nursing Certifications — CFRN combined bank (kept as legacy fallback)
    ...
    caches.open(CACHE_NAME)
      ...
      .then((cache) => {
        ...
        return Promise.allSettled(
          [...HTML_PAGES, ...NCLEX_CATEGORY_ROUTES, ...CFRN_DOMAIN_ROUTES].map(url => 
