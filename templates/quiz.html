...
<body>
  ...
  <div class="container">
    ...
    <div class="title-bar">
      <div>
        <a href="{{ back_url if back_url else '/' }}" id="backLink" style="color: var(--primary); text-decoration: none; font-weight: 600; margin-bottom: 4px; display: inline-block; font-size: 14px;">← {{ back_label if back_label else 'Home' }}</a>
    ...
    <div id="summary" class="card hidden">
      <h2 id="summaryTitle" style="text-align: center; font-size: 2.4em; margin-bottom: 24px;">🎉 Quiz Complete!</h2>
